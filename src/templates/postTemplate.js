...
const PostTemplate = props => {
  ...
  const {
    ...
    featuredImage: {
      imageFile: {
        childImageSharp: { fluid: postImageFluid },
      },
    },
    sections: { content: postIntro },
  } = post;
  const {
    psychologist: {
      avatarimage: {
        imageFile: {
          childImageSharp: { fluid: authorImageFluid },
        },
      },
    },
  } = psychologistBy;
          ...
          >
            ...
            >
              <FacebookShareButton url={shareUrl} title={title}>
                <FaFacebookSquare
                  sx={{ transition: 'link', '&:hover': { color: '#4267B2' } }}
                />
              </FacebookShareButton>
              ...
              <LinkedinShareButton url={shareUrl} title={title}>
                <FaLinkedin
                  sx={{ transition: 'link', '&:hover': { color: '#0e76a8' } }}
                />
              </LinkedinShareButton>
            </Flex>
          </figure>
